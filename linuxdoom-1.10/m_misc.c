...
// UNIX hack, to be removed. 
#ifdef SNDSERV
    {"sndserver", (int *) &sndserver_filename, (long int) "sndserver"},
    {"mb_used", &mb_used, 2},
#endif
    ...
    {"chatmacro0", (int *) &chat_macros[0], (long int) HUSTR_CHATMACRO0 },
    {"chatmacro1", (int *) &chat_macros[1], (long int) HUSTR_CHATMACRO1 },
    {"chatmacro2", (int *) &chat_macros[2], (long int) HUSTR_CHATMACRO2 },
